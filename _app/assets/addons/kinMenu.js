...
class KinMenu {
    ...
    init(){
        ...
        // Set a CSS variable indicating the window size to use in stylesheets
        //document.documentElement.style.setProperty('--kin-menu-window-size', options.windowWidth + 'px');
