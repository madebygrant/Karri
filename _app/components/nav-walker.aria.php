<?php
// ----------- WAI-ARIA Navigation Menu -----------
// Credit: https://github.com/proteusthemes/WAI-ARIA-Walker_Nav_Menu
...
if( !class_exists('Karri\Components\WalkerARIA') ){

    class WalkerARIA extends Walker_Nav_Menu {
        /**
